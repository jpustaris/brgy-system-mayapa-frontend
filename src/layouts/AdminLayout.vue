        ...
        <q-toolbar class="q-my-sm">
          ...
          <q-btn color="primary" flat @click="drawer = !drawer" round dense>
            <q-avatar size="50px" square>
              <img src="~assets/motoshop-logo.jpg">
            </q-avatar>
          </q-btn>
          <q-space />
          ...
          <q-list padding>
            <q-item>
              <q-item-section class="main-title" v-if="!miniState">
                <span class="text-body1 text-weight-bolder text-center">{{ profile.store_name }}</span>
              </q-item-section>
            </q-item> 
            ...
            <q-item class="temp-login-username" v-if="!miniState">
              <p class="text-grey-9">{{ profile.name }}</p>
            </q-item>
            ...
            <div class="sidenav-list">
              ...
              >
                ...
                <q-list>
                  ...
                  <q-item  to="/settings/category-management"  clickable v-ripple exact :class="{ 'selected-sidenav': $route.path === '/settings/category-management' }">
                    <q-item-section class="q-item-section">
                      <span class="text-expansion">Product Category Management</span>
                    </q-item-section>
                  </q-item>

                  <q-item  to="/settings/product-management"  clickable v-ripple exact :class="{ 'selected-sidenav': $route.path === '/settings/product-management' }">
                    <q-item-section class="q-item-section">
                      <span class="text-expansion">Product Management</span>
                    </q-item-section>
                  </q-item>

                  <q-item  to="/settings/store-management"  clickable v-ripple exact :class="{ 'selected-sidenav': $route.path === '/settings/store-management' }">
                    <q-item-section class="q-item-section">
                      <span class="text-expansion">Store Management</span>
                    </q-item-section>
                  </q-item>
                </q-list>
              </q-expansion-item>
