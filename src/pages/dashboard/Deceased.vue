      ...
      <div>
        <!-- <img src="~assets/dashboard-banner.jpg" width="100%"> -->
            <div class="q-pa-md row" style="margin-left: 15px; margin-right: 15px; padding-left: 0px; border-bottom: 2px solid #DEDEDE; ">
                <div class="col-6">
                    <div style="font-size: 20px"><b> Mayapa > Brgy System > Dashboard > Deceased Residents Page</b></div>
                </div>
                <div class="col-6">
        ...
        <div class="col-md-3">
          <q-card
            ...
            <q-card-section>
              ...
              <div class="text-subtitle2">TOTAL DECEASED COUNT</div>
            </q-card-section>
          ...
          <div class="q-pa-md" style="padding-top:20px">
              <q-table
                ...
                class="table"
                title="Deceased Residents Table"
                :rows="rows"
                :columns="columns"
                row-key="name"
...
export default defineComponent({
  ...
  computed: {
    ...mapGetters('ResidentManagement', {
      data: 'GET_DECEASED_RESIDENTS',
      loading: "GET_LOADING",
    }),
    ...mapActions('ResidentManagement',[
      'getDeceasedResidents',
     ]),
  ...
  methods: {
    ...
    async refresh(){
      await this.getDeceasedResidents;
      this.rows = this.data;
    },
