      ...
      <div>
        <!-- <img src="~assets/dashboard-banner.jpg" width="100%"> -->
            <div class="q-pa-md row" style="margin-left: 15px; margin-right: 15px; padding-left: 0px; border-bottom: 2px solid #DEDEDE; ">
                <div class="col-6">
                    <div style="font-size: 20px"><b> Mayapa > Brgy System > Dashboard > Alive Residents Page</b></div>
                </div>
                <div class="col-6">
        ...
        <div class="col-md-3">
          <q-card
            ...
            <q-card-section>
              ...
              <div class="text-subtitle2">ALIVE TOTAL COUNT</div>
            </q-card-section>
