              ...
              <!-- <q-dialog v-model="persistent" persistent transition-show="scale" transition-hide="scale">
                    ...
                    <q-card-section>
                      ...
                      <div class="q-pa-md q-mt-xl">
                        ...
                        <p class="para">
                          ...
                          is included in the Roster of Barangay " <strong>INDIGENT</strong> " as per record in this Office.
                        </p>
                ...
                <q-card style="min-width: 600px">
                  <q-card-section class="bg-teal text-white text-h6">
                    <div >Edit Certificate of Indigency Details</div>
                  </q-card-section>
                  <q-separator />
                  <q-card-section style="max-height: 50vh" class="scroll" >
                    <q-form class="q-gutter-md" >
                    <p class="text-black">Edit Certificate of Indigency Details for control number {{ edit_control_number }}</p>
                    <q-separator></q-separator>  
                    <q-input
                        color="black"
                        bg-color="secondary"
...
export default defineComponent({
  ...
  data: () => ({
      ...
      columns : [
          ...
          label: 'Age',  
          field: row =>  row.resident_details == null ? "  " : 
          row.resident_details.age,
          align: 'center', 
          sortable: true },

          { name: 'gender', label: 'Gender',  
          field: row =>  row.resident_details == null ? "  " : 
          row.resident_details.gender,
          align: 'center', 
          sortable: true },
