        ...
        <div class="col-md-3">
          <q-card
            ...
            <q-card-section>
              ...
              <div class="text-subtitle2">TOTAL CERTIFICATES GOOD MORAL FILED</div>
            </q-card-section>
            </q-card>
        </div>
      </div>
          ...
          <div class="q-pa-md" style="padding-top:20px">
              <q-table
                class="table"
                title="Certificate of Good Moral Management"
                :rows="rows"
                :columns="columns"
                row-key="name"
              ...
              <!-- <q-dialog v-model="persistent" persistent transition-show="scale" transition-hide="scale">
                ...
                <q-dialog v-model="addCertificateForm" transition-show="scale" transition-hide="scale">
                  <q-card  style="min-width: 600px">
                    <q-card-section class="bg-green text-white">
                      <div class="text-h6">Create Certificate of Good Moral</div>
                    </q-card-section>
                    <q-separator />
                ...
                <q-card style="min-width: 600px">
                  <q-card-section class="bg-teal text-white text-h6">
                    <div >Edit Certificate of Good Moral Details</div>
                  </q-card-section>
                  <q-separator />
                  ...
                  <q-card-section style="max-height: 50vh" class="scroll" >
                    <q-form
                      class="q-gutter-md"
                    >
                    <p class="text-black">Edit certificate of good moral details for control number {{ edit_control_number }}</p>
                    <q-separator></q-separator>  
                    <q-input
                        color="black"
                        bg-color="secondary"
