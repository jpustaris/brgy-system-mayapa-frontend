...
<template>
        ...
        <div class="col-md-3">
          <q-card
            ...
            <q-card-section>
              ...
              <div class="text-subtitle2">TOTAL PERSON WITH DISABILITIES </div>
            </q-card-section>
  ...
  <q-dialog v-model="viewPWDDialog">
    <q-card  style="min-width: 1080px">
      <q-card-section class="bg-blue text-white">
        <div class="text-h6">PWD Details</div>
      </q-card-section>
      <q-separator />
      <q-card-section style="max-height: 82vh" class="scroll" >
        ...
        <div class="q-pa-md">
          <table style="font-size: larger;"> 
            ...
            <br><br>
            <q-separator></q-separator>
            <p class="q-pt-md text-black" > <strong> Resident Disability Details</strong></p>
            <q-separator></q-separator>
            <tr>
