...
<template>
        ...
        <div class="col-md-3">
          <q-card
            ...
            <q-card-section>
              ...
              <div class="text-subtitle2">TOTAL HEALTH WORKERS</div>
            </q-card-section>
  ...
  <q-dialog v-model="viewHWDialog">
    <q-card  style="min-width: 1080px">
      <q-card-section class="bg-blue text-white">
        <div class="text-h6">Health Worker Details</div>
      </q-card-section>
      <q-separator />
      <q-card-section style="max-height: 82vh" class="scroll" >
        ...
        <div class="q-pa-md">
          <table style="font-size: larger;"> 
            ...
            <p class="q-pt-md text-black" > <strong>Health Worker Name Details</strong></p>
            <q-separator></q-separator>
            <tr>
            ...
            <br><br>
            <q-separator></q-separator>
            <p class="q-pt-md text-black" > <strong> Health Worker Location Details</strong></p>
            <q-separator></q-separator>
            <tr>
            ...
            <br><br>
            <q-separator></q-separator>
            <p class="q-pt-md text-black" > <strong> Health Worker Disability Details</strong></p>
            <q-separator></q-separator>
            <tr>
              <td>Disability :  <strong>{{ disability }} </strong></td>
            </tr>
            <br><br>
            <q-separator></q-separator>
            <p class="q-pt-md text-black" > <strong> Health Worker Contact and Other Details</strong></p>
            <q-separator></q-separator>
            <tr>
...
export default defineComponent({
  ...
  methods: {
    ...
    async refresh(){
      await this.getHealthWorkers;
      this.rows = this.hws;
    },

    async openViewHWForm(prop){
      await this.setSelected(prop);
      this.viewHWDialog = true;
    },
    ...
    async setSelected(prop){
      ...
      this.disability = prop.row.disability;
